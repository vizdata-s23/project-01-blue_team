...
q1_PE <- ggplot(q1_viz1,
  ...
  theme(
    plot.title = element_text(hjust = 0.5, size = 10),
    axis.line = element_blank(),
    axis.title.x = element_text(hjust = 1.22),
